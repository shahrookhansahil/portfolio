...
export const Home = () => {
  return (
    <div
      name="home"
      className="w-full bg-gradient-to-b from-black via-black
     to-gray-800 text-yellow h-full"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-300 py-4 max-w-md text-xl">
            Experienced in modern front-end frameworks like React and always
            seeking innovation in technology. Proficient in multitasking and
            thrive under pressure. Strong problem-solving skills and a deep
            passion for technology, making me a valuable asset to any
            development team.
          </p>
          <Link
            to="portfolio"
        ...
        <di>
          <img
            src={heroimge}
            className="rounded-2xl mx-auto md:w-full shadow-xl shadow-gray-500"
